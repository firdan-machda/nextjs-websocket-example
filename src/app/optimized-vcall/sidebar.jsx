  ...
  return (
    <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex-auto">
          <div className="p-4 mx-2 bg-white dark:bg-gray-700 rounded-lg shadow">
            <h4 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white">Rooms / Session ID</h4>
        ...
        <div className="flex-auto">
          <form className="max-w-sm mx-2 bg-white dark:bg-gray-700 p-4 rounded-lg shadow" onSubmit={handleCreateSession}>
            <div className="mb-4">
